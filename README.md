...
- **`RsyncProcess`** ([Sources/RsyncProcessStreaming/RsyncProcessStreaming.swift](Sources/RsyncProcessStreaming/RsyncProcessStreaming.swift))
  - `init(arguments:hiddenID:handlers:useFileHandler:)` wires rsync arguments with a user-provided handler set.
...
- **`StreamAccumulator`** (internal) ([Sources/RsyncProcessStreaming/RsyncProcessStreaming.swift](Sources/RsyncProcessStreaming/RsyncProcessStreaming.swift))
